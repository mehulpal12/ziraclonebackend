...
const getCurrentUser = asyncHandler(
  asyncHandler(async (req, res) => {
    return res
      .status(200)
      .json(new ApiResponse(200, req.user, "current user is this"));
  }),
);
...
const resendEmailVerification = asyncHandler(
  asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(200, {}, "mail has been sent");
  }),
);
...
const forgotPasswordRequest = asyncHandler(
  asyncHandler(async (req, res) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, {}, "password reset mail send on mail"));
  }),
);
